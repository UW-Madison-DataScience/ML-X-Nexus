...
│   ├── Workshops
│   ├── Videos
│   ├── Podcasts # Folder currently doesn't exist since no one has contributed a "podcast" resource yet (and git doesn't allow empty folders). Feel free to create this folder, if applicable.
│   ├── Datasets # Folder currently doesn't exist since no one has contributed a "dataset" resource yet (and git doesn't allow empty folders). Feel free to create this folder, if applicable.
│   ├── Models # Folder currently doesn't exist since no one has contributed a "dataset" resource yet (and git doesn't allow empty folders). Feel free to create this folder, if applicable.
├── EDA-examples
├── ML-stories
```
