...
5. Write the post, commit the changes, and [make a pull request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request)

If you don't know how to use Git / GitHub already, it can be a little intimidating at first. A friendlier alternative could be to [download GitHub desktop](https://desktop.github.com/) and setup the repository by following the [Version Control with GitHub Desktop](https://uw-madison-datascience.github.io/ML-X-Nexus/Resources/Guides/Github-desktop.html) guide. The below abbreviated instructions will walk you through how to contribute a new post via GitHub Desktop. If you need additional help (and work in a research lab at UW-Madison), you may also seek help at the Data Science Hub's [office hours ("Coding Meetup")](https://datascience.wisc.edu/hub/#dropin).
...
2. Write your post in the appropriate format. Follow the guidelines on this page for writing a good post, making use the provided template file.
...
0. Before you get started writing the content, create an issue on the [Nexus GitHub](https://github.com/UW-Madison-DataScience/ML-X-Nexus/issues) to announce your intended addition. Follow the conventions of existing issues on Nexus (i.e., title the issue starting with "[Resource]" and add a "Resource" tag), and include why you think this resource (or original content) should be included on the Nexus platform. Please wait for one of the Nexus developers to provide feedback/comments before you get started.
