...
**Video (requires UW netID)**: [View 24-10-14 ML4MI Recording](https://mediaspace.wisc.edu/media/Using+Electronic+Health+Record+Data+to+Predict+Deterioration+in+Hospitalized+Children+-+Anoop+Mayampurath+-+Oct+2024/1_b1hhgnx4).
Most videos on Nexus are publicly available on YouTube, but the #ML4MI ones require a netID.
