...
listing:
  ...
  page-size: 6
  feed:
    title: "ML+X Nexus: All Resources"
    description: "All new ML and AI resources from the UW-Madison ML+X community"
  contents:
    - "Learn/*/**/*.qmd"
