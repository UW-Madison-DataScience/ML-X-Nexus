...
```txt
├── Learn/
│   ├── Books, Guides, Notebooks, Videos, Workshops
...
**Previewing in VSCode:** Install the [Quarto extension](https://marketplace.visualstudio.com/items?itemName=quarto.quarto) for VSCode. Once installed, you can preview `.qmd` files with:
