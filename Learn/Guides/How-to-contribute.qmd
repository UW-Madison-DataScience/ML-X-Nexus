...
### Using generative AI when contributing {#genai-use}

We're not against using GenAI tools — but how you use them matters. The goal of Nexus is to share **your experience**, and no AI model has that. Here's our stance:

- **Use GenAI as a finishing tool, not a drafting tool.** Write the core of your post yourself first — your impressions, your recommendations, your caveats. Then it's fine to use GenAI to polish wording, fill in background context, or improve structure. The starting point should be your own knowledge.
- **Don't let GenAI replace your voice.** If a post reads like it could have been written by anyone about any resource, it probably isn't drawing enough on real experience. The parts that matter most — why *you* found something useful, what tripped you up, who you'd recommend it to — should come from you.
- **Verify everything.** GenAI confidently produces plausible-sounding content that is sometimes wrong. If you use GenAI to help with technical descriptions, prerequisite lists, or background context, double-check every claim with your own understanding. You're the domain expert on your experience — trust your organic brain over the model's output.
- **Don't generate entire posts from scratch with GenAI.** A post that's entirely AI-generated defeats the purpose of Nexus. We review contributions with this in mind and may ask you to revise if a post doesn't appear to reflect firsthand experience.

In short: GenAI can help you say what you mean more clearly, but it can't know what you mean. Start from your own experience, and use AI to support — not substitute — your contribution.
...
| 🚀 | [**Projects**](https://uw-madison-datascience.github.io/ML-X-Nexus/Projects/) | Projects from labs, hackathons, and partners |
...
- [Story: Blog](https://uw-madison-datascience.github.io/ML-X-Nexus/Applications/Blogs/blog-music-identification.html)
