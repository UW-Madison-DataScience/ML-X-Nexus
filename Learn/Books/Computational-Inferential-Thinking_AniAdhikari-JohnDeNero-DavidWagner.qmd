...
date: 2025-08-18
date-format: long
description: "A beginner-friendly introduction to data science, statistics, and Python programming through hands-on exercises — no prior experience assumed."
...
~40–50 hours (reading + hands-on exercises). Use the [Improve this page](https://github.com/UW-Madison-DataScience/ML-X-Nexus/edit/main/Learn/Books/Computational-Inferential-Thinking_AniAdhikari-JohnDeNero-DavidWagner.qmd) functionality to update this estimate!

## Related resources
- [**Workshop**: Intro to Python](https://uw-madison-datascience.github.io/ML-X-Nexus/Learn/Workshops/Intro-Python_Gapminder.html): Additional introductory material for learning Python.
- [**Workshop**: Intro to Machine Learning with Sklearn](https://uw-madison-datascience.github.io/ML-X-Nexus/Learn/Workshops/Intro-ML_Sklearn.html): A natural next step after building foundational data science skills.
