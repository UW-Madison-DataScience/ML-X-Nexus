...
date: 2024-07-14
date-format: long
description: "A modern, theory-focused deep learning textbook covering neural networks, CNNs, transformers, generative models, and reinforcement learning with PyTorch notebooks."
...
~60–80 hours (reading + Colab notebooks). Use the [Improve this page](https://github.com/UW-Madison-DataScience/ML-X-Nexus/edit/main/Learn/Books/Intro-Deeplearning_SimonJDPrince.qmd) functionality to update this estimate!
...
- [**Workshop**: Intro to Deep Learning with Keras](https://uw-madison-datascience.github.io/ML-X-Nexus/Learn/Workshops/Intro-Deeplearning_Keras.html): Learn how to use the Keras deep learning framework
