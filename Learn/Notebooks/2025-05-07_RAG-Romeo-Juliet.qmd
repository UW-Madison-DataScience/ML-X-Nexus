...
description: "Build an end-to-end RAG pipeline from scratch — covering text chunking, semantic embeddings, retrieval, and LLM-based answer generation."
categories:
  - Notebooks
  - RAG
  - Retrieval
...
## Related resources
- [**Project**: WattBot 2025](https://uw-madison-datascience.github.io/ML-X-Nexus/Projects/ML-Marathon/WattBot-2025.html): Put your RAG methods to the test in this ML Marathon challenge focused on AI sustainability estimation.
- [**Talk**: Deploying RAG in Bedrock vs. Local: WattBot 2025 Case Study](https://uw-madison-datascience.github.io/ML-X-Nexus/Applications/Videos/Forums/mlx_2026-02-17.html): Watch an ML+X forum covering the winning WattBot RAG approach deployed in both AWS Bedrock and locally with open-source Hugging Face models.
- [**Compute**: RAG with AWS SageMaker and Bedrock](https://uw-madison-datascience.github.io/ML-X-Nexus/Learn/Workshops/Intro-Amazon_SageMaker.html): This workshop includes a section on how to build RAG pipelines in AWS. It uses the above "WattBot" dataset/challenge as an example use case.
- [**Workshop**: Intro to Natural Language Processing (NLP)](https://uw-madison-datascience.github.io/ML-X-Nexus/Learn/Workshops/Intro-TextAnalysis_Python.html): Brush up on NLP basics before diving head-first into RAG pipelines.
- [**Library**: Hugging Face](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Libraries/HuggingFace.html): This notebook uses several Hugging Face models — learn more about the platform, model discovery, and useful integrations.
