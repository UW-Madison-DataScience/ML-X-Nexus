...
> **Note:** I demo'd this notebook at [ML+Coffee](https://hub.datascience.wisc.edu/communities/mlx/#mlcoffee) on May 7, 2025.  It's an early work in progress, but I hope it's still useful in its current state! I plan to integrate this tutorial into either our [Intro to NLP workshop](https://uw-madison-datascience.github.io/ML-X-Nexus/Learn/Workshops/Intro-TextAnalysis_Python.html) or into a new, dedicated workshop focused on advanced language-model pipelines. Stay tuned — and subscribe to the [ML+X Google Group](https://groups.google.com/a/g-groups.wisc.edu/g/ml-community-of-practice) to stay informed about updates and new workshops.
