...
image: "../../../images/geodeepdive_pipeline.jpg"
jupyter: python3
execute:
  echo: true
...
## Related resources
- [**Workshop**: Intro to Text Analysis / NLP](https://uw-madison-datascience.github.io/ML-X-Nexus/Learn/Workshops/Intro-TextAnalysis_Python.html): Covers NLP fundamentals like tokenization and named entity recognition used by GeoDeepDive's pipeline.
- [**Library**: Pytesseract](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Libraries/PyTesseract.html): An OCR tool for extracting text from images — a key step in GeoDeepDive's document processing.
- [**Data**: Project Gutenberg](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Data/Gutenberg.html): Another large-scale text corpus useful for NLP and text mining research.
