...
These notebooks are meant to be lightweight, interactive learning materials. Some may eventually evolve into full workshops using the [Carpentries workbench template](https://github.com/carpentries/workbench-template-md), but each stands on its own as a handy introduction to key ML/AI ideas.
