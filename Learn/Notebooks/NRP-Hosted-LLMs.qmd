...
2. **Get into an LLM-enabled namespace.** Existing groups: check at [nrp.ai/namespaces](https://nrp.ai/namespaces). New groups: email [support@nationalresearchplatform.org](mailto:support@nationalresearchplatform.org) or ask in [Matrix](https://nrp.ai/contact/).
