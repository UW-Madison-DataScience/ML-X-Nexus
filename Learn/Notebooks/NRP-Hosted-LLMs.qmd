...
A short walkthrough of getting access to the [National Research Platform](https://nrp.ai/)'s hosted, OpenAI-compatible LLM API and making your first calls. The endpoint is free for researchers and educators at [InCommon](https://incommon.org/)-affiliated institutions. For a fuller reference (limits, cluster policies, ML Marathon fit), see the [NRP / Nautilus card](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Compute/NRP-Nautilus.html).
...
2. **Get into an LLM-enabled namespace.** Already in a namespace? Check at [nrp.ai/namespaces](https://nrp.ai/namespaces) (LLM-enabled ones are flagged). Need a new namespace or the LLM flag added? Ask in the **Nautilus Support** channel in [Matrix](https://nrp.ai/contact/) or email [support@nationalresearchplatform.org](mailto:support@nationalresearchplatform.org). See the [NRP / Nautilus card](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Compute/NRP-Nautilus.html) for the three signup patterns (solo, lab, student).
...
- [NRP / Nautilus card](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Compute/NRP-Nautilus.html) — fair-use limits, cluster policies, ML Marathon fit.
