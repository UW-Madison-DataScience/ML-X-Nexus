...
- **[Segment Anything (SAM) (2023)](https://ai.meta.com/research/publications/segment-anything/)**: A foundation model for segmentation, offering high generalization across image domains.
...
## Related resources
- [**Project**: GI Tract Image Segmentation](https://uw-madison-datascience.github.io/ML-X-Nexus/Projects/ML-Marathon/GI-Tract-Image-Segmentation.html): An ML Marathon challenge using U-Net to segment organs in MRI scans for cancer treatment planning.
- [**Project**: Infected Tomato Leaf - Vein Segmentation](https://uw-madison-datascience.github.io/ML-X-Nexus/Projects/ML-Marathon/Infected-Tomato-Leaf-Segmentation.html): An ML Marathon challenge applying U-Net to segment vein structures in infected tomato leaves.
