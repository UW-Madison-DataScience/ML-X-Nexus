...
- **TODO**: [Improve this page](https://github.com/UW-Madison-DataScience/ML-X-Nexus/edit/main/Toolbox/Models/UNET.qmd)
...
## See Also
- [**Playlists**: ML4MI Seminar](https://uw-madison-datascience.github.io/ML-X-Nexus/Applications/Playlists/ML4MI.html). Biomedial applications of ML (especially computer vision) at UW-Madison.
- [**Highlight**: Vision, Language, and Vision-Language Modeling in Radiology](https://uw-madison-datascience.github.io/ML-X-Nexus/Applications/Highlights/ML4MI/24-09-16_Vision-Language-and-VisionLanguage-Modeling-in-Radiology_Tyler-Bradshaw.html): In this ML4MI seminar, Tyler Bradshaw highlights the history and current use of vision (e.g., UNET), language, and vision-language models in medical imaging. 
