...
- **[CART (1984)](https://en.wikipedia.org/wiki/Decision_tree_learning)**: The foundation of decision tree algorithms, focusing on binary splits of data based on feature values.
- **[Random Forest (2001)](https://en.wikipedia.org/wiki/Random_forest)**: Combines many independent decision trees for better accuracy and robustness by reducing variance through bootstrapping.
- **[Gradient Boosting Machines (1999)](https://www.researchgate.net/publication/233878227_Gradient_Boosting_Machine_for_Classification)**: Introduces boosting, sequentially building trees that focus on correcting errors made by previous models.
