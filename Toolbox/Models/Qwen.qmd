...
- **Classic benchmarks**: [MMLU](https://huggingface.co/datasets/cais/mmlu), [GSM8K](https://huggingface.co/datasets/openai/gsm8k), and [HumanEval](https://huggingface.co/datasets/openai/openai_humaneval): Knowledge, math, and code, reported in every Qwen technical report.
