...
- [DeepForest 1.0 (2019)](https://doi.org/10.3390/rs11111309): Released with a pretrained tree crown detection model using RGB imagery  
...
- **Tree crown model**: F1-scores between 0.73 and 0.95 depending on site and canopy structure ([Weinstein et al., 2019, *Remote Sensing*](https://doi.org/10.3390/rs11111309))  
...
- [**Library**: Hugging Face](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Libraries/HuggingFace.html): DeepForest's pretrained models are hosted on the Hugging Face Hub — learn more about the platform and its tools.
