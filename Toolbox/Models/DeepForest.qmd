...
- [DeepForest 1.4–1.5 (2023–2025)](https://deepforest.readthedocs.io/en/latest/release_notes.html): Added support for polygons, PyTorch Lightning, and new models for birds, livestock, and tree health
...
Pretrained  models are available via Hugging Face:
