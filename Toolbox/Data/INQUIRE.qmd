...
description: "A benchmark for evaluating text-to-image retrieval on expert-level ecological queries, built from iNaturalist data with domain-specific relevance judgments."
...
- [**Data**: BioTrove](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Data/BioTrove.html): The largest publicly accessible biodiversity image dataset (161.9M images, ~366K species), also curated from iNaturalist.
...
- [**Library**: Hugging Face](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Libraries/HuggingFace.html): The rerank task is hosted on Hugging Face — learn more about the platform's model and dataset hosting capabilities.
