...
This [guide](https://chtc.cs.wisc.edu/uw-research-computing/machine-learning-htc) provides some of our recommendations for success in running machine learning (specifically deep learning) jobs in CHTC. If you need help leveraging any of the CHTC resources, please reach out to [chtc@cs.wisc.edu](chtc@cs.wisc.edu).
