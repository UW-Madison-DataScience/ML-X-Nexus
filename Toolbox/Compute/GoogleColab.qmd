...
|------|------|----------------|------------------|--------|------------|
| Free | $0 | – | Up to ~12 hours *under ideal conditions* (often much less), ~90 min idle timeout | ~12 GB | Shared GPUs (commonly T4/K80), no guarantees |
...
- [BadgerCompute](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Compute/BadgerCompute.html) – UW–Madison’s lightweight, NetID-authenticated Jupyter service for short interactive sessions and classroom use.
