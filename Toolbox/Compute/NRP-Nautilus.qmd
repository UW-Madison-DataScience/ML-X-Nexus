...
- [**GenAI at UW–Madison**](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/GenAI/GenAI-at-UW-Madison.html) — UW-vetted, free enterprise chat and meeting AI (Google Gemini, Microsoft 365 Copilot, NotebookLM, Zoom AI Companion, WebEx AI Assistant) and policy guidance for sensitive data. For programmatic API access to proprietary frontier models, that route is Bedrock / Vertex AI / Azure OpenAI via UW Cloud Services above.
