...
- [**CHTC**](CHTC.qmd) — better for batch training and hyperparameter sweeps (free GPU Lab, dedicated facilitators).
- [**UW Cloud Services**](UW-Cloud-Services.qmd) (AWS / GCP / Azure) — better when you need guaranteed throughput and low latency for production-style apps, specific hardware (NVLink multi-GPU, newer Blackwell-class GPUs), or managed model-hosting services. Pay per hour, but with UW-negotiated institutional rates and reduced grant overhead.
- [**GenAI at UW–Madison**](../GenAI/GenAI-at-UW-Madison.qmd) — the route for proprietary frontier models (Claude, GPT-4o, Gemini) and HIPAA-eligible inference.
