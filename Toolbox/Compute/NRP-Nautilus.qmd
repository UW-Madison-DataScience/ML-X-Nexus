...
For UW–Madison researchers and teams building LLM- or VLM-based applications, NRP complements rather than replaces other UW options. [CHTC](CHTC.qmd) is still the better choice for batch training and hyperparameter sweeps (free GPU Lab, dedicated facilitators). [GenAI at UW-Madison](../GenAI/GenAI-at-UW-Madison.qmd) is the route for proprietary frontier models (Claude, GPT-4o, Gemini) and HIPAA-eligible inference.
