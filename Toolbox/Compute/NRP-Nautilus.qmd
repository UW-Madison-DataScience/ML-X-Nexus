...
### Other hosted LLM endpoints (call the model via API)

- **NRP** — free, open-weight models (Qwen3, GPT-OSS, Kimi, etc.) via OpenAI-compatible endpoint. Per-user concurrency limits; no service-level agreement; best-effort capacity. Not HIPAA-eliglble. 
- [**UW Cloud Services**](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Compute/UW-Cloud-Services.html) — proprietary frontier via [Bedrock](https://aws.amazon.com/bedrock/) / [Gemini API](https://ai.google.dev/) / [Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/); pay-per-token, fastest latency (hyperscaler hardware) at a fee. UW-provisioned accounts cut grant overhead from 55.5% to 26%, get Internet2 NET+ pricing, and are HIPAA-eligible.

## Getting help

- **Matrix**: [nrp.ai/contact](https://nrp.ai/contact/)
