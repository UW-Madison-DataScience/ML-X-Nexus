...
For UW–Madison researchers and teams building LLM- or VLM-based applications, NRP complements rather than replaces other UW options:
...
- [**UW Cloud Services**](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/Compute/UW-Cloud-Services.html) (AWS / GCP / Azure) — hyperscaler hardware (B200s, NVLink multi-GPU, world-class latency), with direct equivalents to NRP's offerings: hosted LLM APIs via [Amazon Bedrock](https://aws.amazon.com/bedrock/) or [Google's Gemini API](https://ai.google.dev/) (analog of NRP's LLM endpoint), and managed ML platforms — [SageMaker](https://aws.amazon.com/sagemaker/), [Vertex AI](https://cloud.google.com/vertex-ai), [Azure ML](https://azure.microsoft.com/en-us/products/machine-learning) — for notebooks and training (analog of NRP's JupyterHub / GPU pods). Also the route for persistent endpoints that stay up beyond HPC job time limits. Pay-per-hour, but UW-provisioned accounts cut grant overhead from 55.5% to 26%, get Internet2 NET+ pricing, and are HIPAA-eligible.
- [**GenAI at UW–Madison**](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/GenAI/GenAI-at-UW-Madison.html) — proprietary frontier-model services (Claude, GPT-4o, Gemini, ChatGPT Edu) and policy guidance for sensitive data.
...
- [**GenAI**: UW Generative AI Services & Policies](https://uw-madison-datascience.github.io/ML-X-Nexus/Toolbox/GenAI/GenAI-at-UW-Madison.html) — UW-vetted proprietary frontier-model services (Claude, GPT-4o, Gemini, ChatGPT Edu) and policy guidance.
