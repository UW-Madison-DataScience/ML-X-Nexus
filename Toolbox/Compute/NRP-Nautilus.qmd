...
A short code-along. Replace the token bits with your own; the cells aren't executed at build time.

**Install and configure the client.** Store your token in an env var (e.g., a local `.env`), not in code.
