...
## See also
- [**Blog**: What Tune Is That? A Humanities Application of Deep Learning](https://uw-madison-datascience.github.io/ML-X-Nexus/Applications/Blogs/blog-music-identification.html): A Nexus community post applying deep learning to audio and music identification.
- [**Workshop**: Intro to Deep Learning with PyTorch](https://uw-madison-datascience.github.io/ML-X-Nexus/Learn/Workshops/Intro-Deeplearning_PyTorch.html): TorchAudio is built on PyTorch — start here if you're new to the framework.
- [TorchAudio Documentation](https://docs.pytorch.org/audio/stable/index.html): Includes official API as well as tutorials.
- [Getting Started With Torchaudio | PyTorch Tutorial (YouTube)](https://www.youtube.com/watch?v=3mju52xBFK8): In this youtube video from the AssemblyAI youtube channel, you can learn how to code the basic features of TorchAudio, including resampling and incorporating an audio dataset.
- [The MAESTRO Dataset](https://magenta.tensorflow.org/datasets/maestro): Popular dataset containing hundreds of paired audio and MIDI recordings that can be processed with TorchAudio and used for training.
