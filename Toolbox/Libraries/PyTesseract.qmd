...
- [**Workshop**: Intro to Text Analysis / NLP](https://uw-madison-datascience.github.io/ML-X-Nexus/Learn/Workshops/Intro-TextAnalysis_Python.html): Covers NLP fundamentals that complement OCR-based text extraction pipelines.
- [**Notebook**: GeoDeepDive](https://uw-madison-datascience.github.io/ML-X-Nexus/Learn/Notebooks/geodeepdive.html): An example of OCR and NLP applied to scientific text mining at scale.
