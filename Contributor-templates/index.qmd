...
categories: 
  - Deep Learning # Deep Learning, Regression, Transformers, Large language models, Clustering, Decision Trees, etc.
  - PyTorch # PyTorch, Keras, Tensorflow, Sklearn, etc.
  - Workshops # Workshops, Books, Podcasts, Videos, Blogs, etc.
