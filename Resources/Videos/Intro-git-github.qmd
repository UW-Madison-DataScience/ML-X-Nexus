...
- [**Video**: Reproducibility Overview Lecture](https://uw-madison-datascience.github.io/ML-X-Nexus/Resources/Videos/Reproducibility-overview.html): If you're curious to learn how to use Git via shell commands (or just want to become more fluent with Git), check out this YouTube playlist from the Data Science Hub!
